...
async function generateInterviewReport({ resume, selfDescription, jobDescription }) {
    ...
    const prompt = `Generate an interview report for a candidate with the following details:
                        ...
                        - At least 5 technical questions with their intentions and detailed answers
                        - At least 3 behavioral questions with their intentions and detailed answers
                        - All relevant skill gaps with severity levels
                        - A 7-day preparation plan with specific tasks for each day `
...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
    ...
    const response = await ai.models.generateContent({
        ...
        config: {
            responseMimeType: "application/json",
            responseSchema: {                          // ✅ replace zodToJsonSchema(resumePdfSchema)
                type: Type.OBJECT,
                properties: {
                    html: {
                        type: Type.STRING,
